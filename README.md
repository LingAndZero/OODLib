...
## Implemented OOD Methods (sorted by date)
...
|CADRef|[caref.py](./baselines/dnn_based/caref.py)&[cadref.py](./baselines/dnn_based/cadref.py)|[CADRef: Robust Out-of-Distribution Detection via Class-Aware Decoupled Relative Feature Leveraging](https://openaccess.thecvf.com/content/CVPR2025/papers/Ling_CADRef_Robust_Out-of-Distribution_Detection_via_Class-Aware_Decoupled_Relative_Feature_Leveraging_CVPR_2025_paper.pdf) [CVPR 2025]|